...
export function DateTimePicker({
  ...
  const presetBtn =
    "whitespace-nowrap rounded-md px-2.5 py-1.5 text-left text-xs font-medium text-foreground hover:bg-brand/10 hover:text-brand";
  const selectCls =
    "rounded-md border border-border bg-surface px-2 py-1 text-xs font-bold outline-none focus:border-brand";
    ...
    <div className="relative w-full" ref={ref}>
      ...
      >
        <div className="flex items-center gap-2 truncate">
          <Icon d={CAL} className="h-4 w-4 shrink-0 text-brand" />
          ...
          <div className="flex flex-1 flex-col p-3">
              ...
              <div className="border-t border-border pt-2.5">
                <div className="mb-2 flex items-center justify-between gap-2">
                  <div className="flex shrink-0 items-center gap-1.5 text-[11px] font-bold text-muted">
                    <Icon d={CLOCK} className="h-3.5 w-3.5 text-brand" />
                    Giờ:
                  </div>
                      ...
                      <button
                        ...
                        className={`shrink-0 rounded-md px-2 py-0.5 text-[10px] font-bold ${
                          hours === tp.h && minutes === tp.m
                            ? "bg-brand text-white"
                            : "bg-background text-muted hover:bg-brand/10"
                        }`}
                      >
                        {pad(tp.h)}:{pad(tp.m)}
                      </button>
            ...
            <div className="mt-2.5 flex justify-end border-t border-border pt-2">
              <button
                ...
                className="rounded-lg bg-brand px-3.5 py-1.5 text-xs font-bold text-white shadow-sm hover:bg-brand-dark"
              >
                Xác nhận
              </button>
            </div>
